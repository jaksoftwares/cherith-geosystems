...
export function Partners() {
  ...
  return (
    <section className="py-12 md:py-20 bg-white border-y border-brand-grey/30 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-8 mb-12 text-center relative z-10">
        ...
        >
          <span className="text-brand-red font-bold tracking-widest uppercase text-xs md:text-sm mb-4 block">
            Our Strategic Reach
          </span>
          <h2 className="text-3xl md:text-5xl font-bold font-cherith text-brand-blue mb-6 tracking-tight">
      ...
      <div className="relative flex overflow-hidden py-4 group">
        <div className="flex animate-marquee whitespace-nowrap gap-12 md:gap-24 items-center">
          {duplicatedPartners.map((partner, idx) => (
            ...
            >
               <span className="text-2xl md:text-4xl font-extrabold font-cherith text-brand-blue/20 group-hover/item:text-brand-blue transition-all duration-500 tracking-tighter hover:scale-105 transform inline-block">
                {partner.name}
              </span>
              <span className="text-[10px] md:text-xs font-bold text-brand-red/30 group-hover/item:text-brand-red transition-all duration-500 uppercase tracking-[0.2em] mt-2">
                {partner.subtitle}
              </span>
            </div>
          ))}
