...
export function Footer() {
  ...
  return (
    <footer className="bg-brand-blue text-white pt-12 md:pt-16 pb-8 md:pb-10">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-12">
          
          {/* Brand & Bio */}
          <div className="flex flex-col gap-5">
            <Link href="/" className="inline-block relative w-48 h-14 sm:w-56 sm:h-16 md:w-64 md:h-18">
              <Image 
          ...
          <div className="flex flex-col gap-5 lg:pl-8">
            <h3 className="text-lg font-bold font-cherith text-white">Quick Links</h3>
            <ul className="flex flex-col gap-2">
              {['Home', 'About Us', 'Services', 'Projects', 'Experience', 'Insights', 'Contact'].map((link) => (
                <li key={link}>
                  <Link 
                    href={
                      link === 'Home' ? '/' : 
                    ...
                    className="text-gray-300 hover:text-brand-red transition-colors flex items-center gap-2 group text-sm"
                  >
                    <ArrowRight className="w-3.5 h-3.5 text-brand-red opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all font-bold" />
                    {link}
                  </Link>
                </li>
              ))}
          ...
          {/* Core Services */}
          <div className="flex flex-col gap-5">
            <h3 className="text-lg font-bold font-cherith text-white">Our Services</h3>
            <ul className="flex flex-col gap-2">
              {[
                ...
                <li key={service.slug}>
                  <Link href={`/services/${service.slug}`} className="text-gray-300 hover:text-brand-red transition-colors text-sm">
                    {service.name}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact Info */}
          <div className="flex flex-col gap-5">
            <h3 className="text-lg font-bold font-cherith text-white">Contact Us</h3>
            <ul className="flex flex-col gap-3.5">
              <li className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-xs mt-1 leading-relaxed">Olympic House, 1st Floor, Room 104<br/>P.O. Box 1968-00200<br/>Nairobi, Kenya</p>
                </div>
              </li>
