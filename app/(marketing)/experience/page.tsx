...
export default function ExperiencePage() {
  return (
    <main className="flex flex-col min-h-screen bg-zinc-50">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-brand-blue overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 text-brand-red font-bold uppercase tracking-[0.2em] text-sm mb-6">
              <span className="w-12 h-[2px] bg-brand-red block"></span>
              Experience Beyond the Horizon
            </div>
            <h1 className="text-4xl md:text-7xl font-bold font-cherith text-white mb-8 leading-[1.1]">
      ...
      <section className="py-12 bg-white border-b border-gray-100">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="flex flex-col gap-1 border-l-2 border-brand-red pl-6">
              <span className="text-3xl md:text-4xl font-bold text-brand-blue font-cherith">08+</span>
              <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Countries Reached</span>
            </div>
            <div className="flex flex-col gap-1 border-l-2 border-brand-red pl-6">
              <span className="text-3xl md:text-4xl font-bold text-brand-blue font-cherith">400+</span>
              <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Successful Projects</span>
            </div>
            <div className="flex flex-col gap-1 border-l-2 border-brand-red pl-6">
              <span className="text-3xl md:text-4xl font-bold text-brand-blue font-cherith">19+</span>
              <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Years of Expertise</span>
            </div>
            <div className="flex flex-col gap-1 border-l-2 border-brand-red pl-6">
              <span className="text-3xl md:text-4xl font-bold text-brand-blue font-cherith">UN+</span>
      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4 md:px-8">
          <div className="mb-20 max-w-3xl">
            <h2 className="text-3xl md:text-5xl font-bold font-cherith text-brand-blue mb-6">Regional Operations</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regionalEscperience.map((exp, idx) => (
              <div 
                key={idx} 
                className="group bg-white p-8 md:p-10 rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col h-full"
              >
                <div className="flex items-center justify-between mb-8">
                  <div className="w-16 h-16 rounded-2xl bg-zinc-50 flex items-center justify-center group-hover:bg-brand-red group-hover:text-white transition-colors duration-500 text-brand-blue">
                    <Globe2 className="w-8 h-8" />
                  </div>
                  <span className="text-[10px] font-bold text-brand-red uppercase tracking-[0.2em]">0{idx + 1}</span>
                </div>
                
                <h3 className="text-2xl font-bold font-cherith text-brand-blue mb-4 group-hover:text-brand-red transition-colors">{exp.country}</h3>
                <div className="flex items-center gap-2 text-brand-blue/60 mb-6">
                  <Briefcase className="w-4 h-4" />
                  <span className="text-sm font-bold">{exp.projects}</span>
                </div>
                ...
                <div className="pt-6 border-t border-gray-50">
                  <div className="flex flex-wrap gap-2">
                    {exp.expertise.map((skill, sIdx) => (
                      <span key={sIdx} className="text-[9px] font-bold uppercase tracking-wider px-3 py-1.5 bg-zinc-50 rounded-lg text-gray-400 group-hover:bg-brand-blue/5 group-hover:text-brand-blue transition-colors">
                        {skill}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-20 bg-brand-blue relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center text-white">
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            <Building2 className="w-16 h-16 text-brand-red mb-8" />
            <h2 className="text-3xl md:text-5xl font-bold font-cherith mb-8">Strategic Partnerships</h2>
            ...
            <div className="flex flex-wrap justify-center gap-12">
              <div className="flex flex-col items-center gap-3">
                <span className="text-brand-red text-sm font-bold uppercase tracking-widest">UN Agencies</span>
                <span className="w-12 h-0.5 bg-brand-red/30"></span>
              </div>
              <div className="flex flex-col items-center gap-3">
                <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Financial Institutions</span>
                <span className="w-12 h-0.5 bg-brand-red/30"></span>
              </div>
              <div className="flex flex-col items-center gap-3">
                <span className="text-brand-red text-sm font-bold uppercase tracking-widest">Regional Bodies (IGAD)</span>
                <span className="w-12 h-0.5 bg-brand-red/30"></span>
              </div>
            </div>
          </div>
